...
class Tasks extends Table {
  ...
  late final Column<String> description =
      text().nullable().withDefault(Constant(null))();
  ...
  late final Column<DateTime> dueDate =
      dateTime().nullable().withDefault(Constant(null))();
}
